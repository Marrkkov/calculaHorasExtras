        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <h1 class="mt-4">Cargar Reloj Control</h1>

                    <div class="form-group col-lg-6">
							<label for="precio">Cargar Archivo Reloj Control</label> <input id="reloControl"
								name="relojControl" type="file" class="form-control" />
					</div>
